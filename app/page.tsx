...
const upcomingEvents = [
  {
    ...
    description: "From Mountain Farms to Coastal Fields. Welcome social, tours and lunch ($25), dinner ($50), and SWM in person ($50) or virtual ($15). Hosted at Holiday Inn Express & Suites.",
    featured: true,
    category: "Meeting",
  },
  {
    ...
    description: "Two-day legislative event featuring a light luncheon, legislative briefing, Cornucopia Dinner with sponsors and guests, and legislative visits. $125 per person. Sheraton Grand, 1230 J Street. Registration deadline April 13th.",
    featured: false,
    category: "Advocacy",
  },
];
