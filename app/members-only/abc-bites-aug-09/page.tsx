...
export const metadata: Metadata = {
  title: "ABC AG Bites – Aug 09",
  description:
    "ABC AG Bites agriculture news update for August 9. Members only content from California Women For Agriculture.",
};

export default function AgBitesAug09Page() {
  return (
    <>
      <Hero
