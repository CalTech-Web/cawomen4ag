...
export default function Hero({
  ...
  if (!compact) {
    return (
      <section className="relative w-full min-h-screen flex items-end -mt-[75px]">
        {bgImage && (
          <Image
            src={bgImage}
            alt=""
  ...
  return (
    <section className="relative w-full min-h-[50vh] flex items-center justify-center text-center -mt-[75px]">
      {bgImage && (
        <>
